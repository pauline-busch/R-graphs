...
all_Data <- data.table(
  read.xlsx("Microscopy_repletion.xlsx"))
...
ggsave("result_repletion2.tiff", path = "C:/Users/Rickman/Documents/GitHub/R-graphs/Graphs and figures", units = "in", dpi=300, compression = 'lzw', width = 8, height = 6)

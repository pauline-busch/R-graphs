...
f.sample <- factor(
  use_Data3$sample, level = c("blank", "CDNB15","CDNB60"))

ggplot(data = use_Data3,
       aes(x = f.sample, 
           y = EI)) +
...
ggsave("result_deformability(c).tiff", path = "C:/Users/miri/Desktop/R/R-graphs/Graphs and figures", units = "in", dpi=300, compression = 'lzw', width = 8, height = 6)

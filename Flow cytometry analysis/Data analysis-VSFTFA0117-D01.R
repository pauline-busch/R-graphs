...
PMCA_data <- read_xlsx("C:/Users/paubus/OneDrive - Universität Zürich UZH/Documents/GitHub/R-graphs/Flow cytometry analysis/events-Jerone Van1.1.xlsx")
...
ggsave("FC_data.tiff", 
       path = "C:/Users/paubus/OneDrive - Universität Zürich UZH/Documents/GitHub/R-graphs/Flow cytometry analysis/graphs", 
       units = "in", 
       dpi=300, 
       compression = 'lzw',
       width = 7, 
...
# Save the binned data as excel file
write.xlsx(PMCA_data, "~/GitHub/R-graphs/Flow cytometry analysis/binned-Jerone Van1.1.xlsx")
